package ua.lviv.lgs.periodacals.config;
...
import ua.lviv.lgs.periodacals.security.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/home").access("hasRole('USER_ROLE')").anyRequest().permitAll().and()
